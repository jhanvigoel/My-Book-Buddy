        ...
        <div className="min-h-screen w-full py-16 px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-7xl mx-auto">
                <div className="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-transform text-center border border-[#8C87AA]/10">
                    ...
                    <h3 className="text-2xl font-bold text-[#8C87AA] mb-2">Get Recommended Books</h3>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-transform text-center border border-[#8C87AA]/10">
                    ...
                    <h3 className="text-2xl font-bold text-[#8C87AA] mb-2">Track Your Reads</h3>
                    <p className="text-gray-600 text-lg">
                ...
                <div className="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-transform text-center border border-[#8C87AA]/10">
                    ...
                    <h3 className="text-2xl font-bold text-[#8C87AA] mb-2">Make Friends</h3>
                    <p className="text-gray-600 text-lg">
