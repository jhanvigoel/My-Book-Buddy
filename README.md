...
- Book discovery: Search across titles/authors with responsive UI. Empty queries gracefully show a popular feed so users always have something to explore.
...
![BookSearch](client/public/BookSearch.png)
BookSearch: Search your favourite book by name and author, designed with google books api.
